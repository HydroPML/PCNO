...
parser.add_argument("--txt_suffix", type=str, default="1D_KDE_PCNO-Refiner_seed1", help="suffix to add to the results txt")
...
path_model_con = 'Path_to/Models/1D_KSE/PCNO/Fixed_viscosity/model.pt'
