...
parser.add_argument("--results_path", type=str, default="/Path_to/results/FNO/NS/", help="path to store results")
parser.add_argument("--suffix", type=str, default="seed1", help="suffix to add to the results path")
parser.add_argument("--txt_suffix", type=str, default="ns_V1e-3_N10000_T30_FNO_seed1", help="suffix to add to the results txt")
