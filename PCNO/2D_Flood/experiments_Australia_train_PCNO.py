...
parser.add_argument("--txt_suffix", type=str, default="Flood_FNO_Au_seed1", help="suffix to add to the results txt")
...
print(f"{args.model_type} done training for Target domain; \nTest: {test_l2 / ntest}, Test_nse: {test_nse * batch_size / ntest}, Test_corr: {test_corr * batch_size / ntest}, Test_csi_1: {test_csi_1 * batch_size / ntest}, "
      f"Test_csi_2: {test_csi_2 * batch_size / ntest}, Test_csi_3: {test_csi_3 * batch_size / ntest}, Test_csi_4: {test_csi_4 * batch_size / ntest}")
